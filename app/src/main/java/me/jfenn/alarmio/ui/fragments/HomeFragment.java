package me.jfenn.alarmio.ui.fragments;
...
import me.jfenn.alarmio.ui.adapters.SimplePagerAdapter;
import me.jfenn.alarmio.ui.dialogs.AestheticTimeSheetPickerDialog;
import me.jfenn.alarmio.ui.dialogs.TimerDialog;
import me.jfenn.alarmio.ui.views.PageIndicatorView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        colorAccentSubscription = Aesthetic.Companion.get()
                ...
                .subscribe(integer -> {
                    ...
                    int color = ContextCompat.getColor(getContext(), getAlarmio().getActivityTheme() == Alarmio.Companion.getTHEME_AMOLED() ? R.color.textColorPrimary : R.color.textColorPrimaryNight);
